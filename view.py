...
class JanelaPergunta:
    ...
    def obter_arquivo(self):
        self.janela.controller.figuras = Camadas(open(askopenfilename(defaultextension=".chdd",
                                                                      filetypes=(("Arquivos Cheddar", "*.chdd"),
                                                                                 ("Todos os arquivos",
                                                                                  "*.*")))).read().split("|")[:-1])
...
class Janela:
    def __init__(self):
        ...
        # -------------- BUTOES -------------------------
        # -------------- Caixas de Selecao --------------
        self.TXTLinha = Label(self.FrameGrid, text="Cor da Linha: ", fg="#F2E9E4", bg="#271450",
                              font=("Arial", 12, "bold"))
        ...
        self.TXTPreenchimento = Label(self.FrameGrid, text="Cor do Preenchimento: ", fg="#F2E9E4", bg="#271450",
                                      font=("Arial", 12, "bold"))
        ...
        self.TXTEspessura = Label(self.FrameGrid, text="Selecione a Expessura: ", fg="#F2E9E4", bg="#271450",
                                  font=("Arial", 12, "bold"))
        self.Espessura = Scale(
            ...
            command=self.escolher_espessura
        )
        # -------------- Caixas de Selecao --------------
        # --------------- Grid --------------------------
    ...
    def apagartudo(self):
        self.controller.figuras = Camadas()
        self.CanvaGrid.delete("all")

    def criar_arquivo(self):
        self.controller.caminho = asksaveasfilename(defaultextension=".chdd",
                                                    filetypes=[("Arquivos Cheddar", "*.chdd")])
